...
public:
	...
	Fix<s, T> signum() const { Fix<s, T> ret; ret.value = value > 0 ? ret.value = 1 << s : value < 0 ? ret.value = -(1 << s) : 0; return ret; }		// NEW
...
constexpr FFix ZERO = 0;
constexpr FFix ONE = 1;
constexpr FFix TWO = 2;
constexpr FFix THREE = 3;
constexpr FFix TEN = 10;

constexpr FFix HUNDREDTH = 0.01f;
constexpr FFix TENTH = 0.1f;
constexpr FFix HALF = 0.5f;
